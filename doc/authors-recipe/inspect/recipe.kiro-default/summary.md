...
| Settings | INVENTORY | 249 | 0 | 0 | [settings.draft.md](settings.draft.md) |
| Extensions | INVENTORY | 67 | 0 | 0 | [extensions.draft.md](extensions.draft.md) |
...
- extension/ms-vscode-remote.remote-containers.settings.json
- extension/ms-vscode-remote.remote-ssh-edit.settings.json
- extension/ms-vscode-remote.remote-ssh.settings.json
- extension/ms-vscode-remote.remote-wsl.settings.json
- extension/ms-vscode-remote.vscode-remote-extensionpack.settings.json
- extension/ms-vscode.hexeditor.settings.json
- extension/ms-vscode.remote-explorer.settings.json
- extension/ms-vscode.remote-server.settings.json
...
- runtime.theme.kiro-dark.settings.json

## Resolution

- Recipe source: `$CTK_HOME/cookbook/recipe/kiro-default.macos.yaml`
- Resolver: Cookbook Resolver with declared Go Merge Rules
- Generated: `2026-08-03T13:45:35+09:00`
